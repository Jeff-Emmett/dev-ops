...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 KeePassXC installed and launching
- [ ] #2 Vault created with Argon2id KDF at decided parameters
- [ ] #3 Key file generated and stored in secure location
- [ ] #4 Folder structure created per vault design
- [ ] #5 Auto-lock configured
- [ ] #6 Password generator configured
- [ ] #7 Vault file stored in Syncthing-watched directory
<!-- AC:END -->

## Implementation Notes

<!-- SECTION:NOTES:BEGIN -->
KeePassXC installed, vault opens via WSL path from Windows side
<!-- SECTION:NOTES:END -->
